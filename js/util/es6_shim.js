...
E.t.includes = function(search, index){
    return this.indexOf(search, index)>=0; };
if (!String.prototype.includes)
    String.prototype.includes = E.t.includes;
...
E.t.every = function(callbackfn, thisArg){
    if (this==null)
    ...
    if (typeof callbackfn!=='function')
        throw new TypeError();
    for (var k = 0, len = arr.length|0; k<len; k++)
    {
        if (!(k in arr))
            continue;
        if (!callbackfn.call(thisArg, arr[k], k, arr))
            return false;
    }
    return true;
};
if (!Array.prototype.every)
  Array.prototype.every = E.t.every;
