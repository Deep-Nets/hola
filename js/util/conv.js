...
E.md5_etag = function(buf){
    // update ignores its encoding argument when applied to a Buffer,
    // but for strings, the default encoding is 'binary', which is a lossy
    // conversion to latin-1
    return crypto.createHash('md5').update(buf, 'utf8')
