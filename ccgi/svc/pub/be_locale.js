...
var locales = ('af ar az be bg bs ca cs cy da de el en es et eu '+
    'fa fi fr ga gl gu he hi hr hu hy ht id is it ja ka kn ko ku lt lv '+
    'mk ms my nl no pl pt ro ru sk sl sr sv sw th tl tr uk vi '+
    'bn km mr mt pt_BR sq ta te ur zh_CN zh_TW').split(' ');
locales.sort();
